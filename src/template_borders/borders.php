...
$logo =
  '<a href="/"><img src="https://dc69b531ebf7a086ce97-290115cc0d6de62a29c33db202ae565c.ssl.cf1.rackcdn.com/101/Sure_Dry_Only_2018.png" alt="[company]" title="[company]" border="0"></a>';
$mainVideo = "omdRKtMWNUg";
$socialFooter = '
  <a href="https://www.facebook.com/Sure-Dry-Basement-Systems-Inc-98061056985/" title="Like Us on Facebook">
  <img src="/core/images/templates/health/fb-icon-light.png" alt="Facebook"></a>
  <a href="http://twitter.com/#!/SureDryBasement" title="Follow Us on Twitter">
  <img src="/core/images/templates/health/tw-icon-light.png" alt="Twitter"></a>
  <a href="http://www.flickr.com/photos/suredrybasements" title="Follow Us on Flickr">
  <img src="/core/images/templates/health/social-icons/flickr-icon-light.png" alt="Flickr"></a>
  <a href="http://www.youtube.com/user/SureDryBasements?feature=watch" title="Subscribe to us on YouTube">
  <img src="/core/images/templates/health/yt-icon-light.png" alt="YouTube"></a>
  ';
?>

<?php
    // Use this var to select the page based on type
    // I want to use switch statements but...PHP
    $pageType = "";
    if($thePage == "index") {
        $pageType = 'HOME';
...
<head>
  ...
  <!-- Styles (Global)-->
  <link rel="stylesheet" type="text/css" href="https://min.gitcdn.link/repo/IamStephan/c4f18bfd2fd253373929fd607c718c90/raw/fa12ed4c9b163ad346ca564f10497dca6e5b3778/suredry_global_template.css">

  <!-- Selected scripts and styles -->
  <?php
    if($pageType == "HOME") {
  ?>
    <link rel="stylesheet" type="text/css" href="https://min.gitcdn.link/repo/IamStephan/c4f18bfd2fd253373929fd607c718c90/raw/fa12ed4c9b163ad346ca564f10497dca6e5b3778/suredry_homepage_template.css">
  <?php
    }
  ?>
  <?php
    if($pageType == "CONTENT") {
  ?>
    <link rel="stylesheet" type="text/css" href="https://min.gitcdn.link/repo/IamStephan/c4f18bfd2fd253373929fd607c718c90/raw/fa12ed4c9b163ad346ca564f10497dca6e5b3778/suredry_content_template.css">
  <?php
    }
  ?>
</head>
...
<body id="app">
  ...
  <footer class="footer">
    ...
    <script src="https://min.gitcdn.link/repo/IamStephan/c4f18bfd2fd253373929fd607c718c90/raw/fa12ed4c9b163ad346ca564f10497dca6e5b3778/main.js"></script>

    <?php
    if($pageType == "CONTENT") {
    ?>
      <script src="https://min.gitcdn.link/repo/IamStephan/c4f18bfd2fd253373929fd607c718c90/raw/fa12ed4c9b163ad346ca564f10497dca6e5b3778/silo.js"></script>
    <?php
      }
    ?>
  </body>
